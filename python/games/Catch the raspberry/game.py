...
def controlleerLevens():
	...
	if life <= 0:
		...
		#scherm.fill(Achtergrondkleur) 													# Vul de achtergrond met een neutrale kleur
		scherm.blit(bg,(0,0))
		gameoverlabel = font_big.render("GAME OVER", 1, WIT) 						# Zet de gameover tekst in een variabele
		musiccredits = font_medium.render("Music by Kevin mcleoud", 1, WIT) 		# Zet de gameover tekst in een variabele
...
def tekenScherm():
	...
	#scherm.fill(Achtergrondkleur)		# Vul het scherm met een kleur
	scherm.blit(bg,(0,0))
